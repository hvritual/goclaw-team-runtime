...
const file_workspace_v1_workspace_proto_rawDesc = "" +
	"\n" +
	"\x1cworkspace/v1/workspace.proto\x12\fworkspace.v1\x1a\x1bannotations/v1/access.proto\x1a\x1cgoogle/api/annotations.proto\"\r\n" +
	"\vPingRequest\"(\n" +
	"\fPingResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2\x93\x01\n" +
	"\x10WorkspaceService\x12_\n" +
	"\x04Ping\x12\x19.workspace.v1.PingRequest\x1a\x1a.workspace.v1.PingResponse\" \xd2\xf3\x18\x028\x01\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/workspace/ping\x1a\x1e\xca\xf3\x18\x1a\n" +
...
var file_workspace_v1_workspace_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_workspace_v1_workspace_proto_goTypes = []any{
	(*PingRequest)(nil),  // 0: workspace.v1.PingRequest
	(*PingResponse)(nil), // 1: workspace.v1.PingResponse
}
var file_workspace_v1_workspace_proto_depIdxs = []int32{
	0, // 0: workspace.v1.WorkspaceService.Ping:input_type -> workspace.v1.PingRequest
	1, // 1: workspace.v1.WorkspaceService.Ping:output_type -> workspace.v1.PingResponse
