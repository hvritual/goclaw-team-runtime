...
var (
	...
	ErrInvitationMemberExists    = errors.New("you are already a member of this workspace")
	ErrInvitationChanged         = errors.New("invitation is no longer pending")
	ErrInvitationOnboarding      = errors.New("failed to complete onboarding")
