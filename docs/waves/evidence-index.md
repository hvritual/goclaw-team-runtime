...
| `FE-EVID-W01-021` | `FE-W01` | `FE-ISSUE-007`、`010` | recovered-base MVP environment preflight | UI 8/8、production build 与 Gateway/session/agent race 通过；Browser localhost 动作、ptrace capability 和 credential owner 均失败关闭 | [r012 MVP environment-blocked](frontend-stability/fe-w01/s13-r012-mvp-environment-blocked.md)（SHA-256 `5baf3087d4cc94f701c810216081a8758848559010c1bf9b632a2dd1bc36eea9`） | `failed` | `recovery_code_review` + `recovery_security_review` + `recovery_docs_review`：失败 Evidence accepted，MVP 未放行 |
...
| `TR-EVID-W00-001` | `TR-W00` | `TR-ISSUE-001` | application boundary | 双入口、命令隔离、兼容入口、18 binary 交叉构建、Go/UI/Obsidian 和 release Gate 通过 | [S05 application boundary verification](team-runtime/tr-w00/s05-application-boundary-verification.md)（SHA-256 `49e9e87c38ae25b1a36cf4f64e4daac697628130a04483fb87a26c236cc6cd36`） | `passed` | deterministic + `tr_w00_code_review` + `tr_w00_security_review` + `tr_w00_docs_review` |
| `TR-EVID-W00-002` | `TR-W00` | `TR-ISSUE-002` | initial independent review | r001 exact head 的 code/security/docs P1 与提前合并偏差完整登记 | [S05 independent review r001](team-runtime/tr-w00/s05-independent-review-r001.md) | `failed` | code P1=2；security P1=2；docs P1=4 |
| `TR-EVID-W00-003` | `TR-W00` | `TR-ISSUE-001`、`002` | r002 final verification | exact `60465b59...` 的 deterministic Gate 与三路复核均 P0=0/P1=0 | [S08 r002 final verification](team-runtime/tr-w00/s08-r002-final-verification.md) | `passed` | `tr_w00_code_review` + `tr_w00_security_review` + `tr_w00_docs_review` |
| `TC-EVID-W01-001` | `TC-W01` | `TC-ISSUE-001` | control plane contracts | 预算、知识源、Skill、Runner release、Context Bundle 的 RBAC/并发/持久化测试通过 | [S05 deterministic verification](team-runtime/tc-w01/s05-deterministic-verification.md) | `collecting` | deterministic passed；independent review pending |
| `TC-EVID-W01-002` | `TC-W01` | `TC-ISSUE-001` | r002 independent review | exact `6aab01f...` 的 code/security/docs P1 与 trace deviation | [S05 independent review r002](team-runtime/tc-w01/s05-independent-review-r002.md) | `failed` | code P1=2；security P1=2；docs P1=3 |
| `TC-EVID-W01-003` | `TC-W01` | `TC-ISSUE-001` | r003 remediation | 复合 key、Context identity、secret-safe schema、CRUD、UI 五状态与 replay no-op | [S07 r003 remediation verification](team-runtime/tc-w01/s07-r003-remediation-verification.md) | `superseded` | deterministic passed；exact `86f68235...` review failed，转 TC-EVID-W01-004/005 |
| `TC-EVID-W01-004` | `TC-W01` | `TC-ISSUE-001` | r003 independent review 1 | exact `86f68235...` 的状态机、legacy usage/JS-safe、URI、migration/CRUD Evidence 与 JSON 合同 P1 | [S08 r003 independent review 1](team-runtime/tc-w01/s08-r003-independent-review-1.md) | `failed` | code P1=4；security P1=2；docs P1=2 |
| `TC-EVID-W01-005` | `TC-W01` | `TC-ISSUE-001` | r003 review remediation 2 | 初审全部 P1、主要 P2 与完整 Evidence/JSON 合同前向修复 | [S08 r003 review remediation 2](team-runtime/tc-w01/s08-r003-review-remediation-2.md) | `superseded` | deterministic passed；exact review `TC-EVID-W01-006` failed |
| `TC-EVID-W01-006` | `TC-W01` | `TC-ISSUE-001` | r003 independent review 2 | exact `961a9329...` code PASS；file URI parsed UNC/device P1 | [S08 r003 independent review 2](team-runtime/tc-w01/s08-r003-independent-review-2.md) | `failed` | code P1=0 PASS；security P1=1 BLOCK；docs not run |
| `TC-EVID-W01-007` | `TC-W01` | `TC-ISSUE-001` | r003 review remediation 3 | parsed/unescaped file URI UNC/device 与父目录写边界 | [S08 r003 review remediation 3](team-runtime/tc-w01/s08-r003-review-remediation-3.md) | `superseded` | deterministic passed；exact review `TC-EVID-W01-008` failed |
| `TC-EVID-W01-008` | `TC-W01` | `TC-ISSUE-001` | r003 independent review 3 | exact `2bce7317...` code PASS；Windows/Unix device path P1 | [S08 r003 independent review 3](team-runtime/tc-w01/s08-r003-independent-review-3.md) | `failed` | code P1=0 PASS；security P1=1 BLOCK；docs not run |
| `TC-EVID-W01-009` | `TC-W01` | `TC-ISSUE-001` | r003 review remediation 4 | DOS/NT device、Unix pseudo-filesystem、错误脱敏与 Policy canonical trim | [S08 r003 review remediation 4](team-runtime/tc-w01/s08-r003-review-remediation-4.md) | `superseded` | deterministic passed；exact review `TC-EVID-W01-010` failed |
| `TC-EVID-W01-010` | `TC-W01` | `TC-ISSUE-001` | r003 independent review 4 | exact `e879b0e2...` traversal/superscript device 与 r002 RBAC scope provenance P1 | [S09 r004 independent review 4](team-runtime/tc-w01/s09-r004-independent-review-4.md) | `failed` | code P1=1；security P1=2；docs P1=1 |
| `TC-EVID-W01-011` | `TC-W01` | `TC-ISSUE-001` | r004 remediation | lexical path、superscript DOS device、error/length boundary 与 RBAC provenance 前向实现 | [S10 r004 remediation verification](team-runtime/tc-w01/s10-r004-remediation-verification.md) | `superseded` | deterministic passed；exact review `TC-EVID-W01-012` failed |
| `TC-EVID-W01-012` | `TC-W01` | `TC-ISSUE-001` | r004 independent review 5 | exact `32544825...` cross-platform rooted DOS device P1 | [S11 r004 independent review 5](team-runtime/tc-w01/s11-r004-independent-review-5.md) | `failed` | code/docs PASS；security P1=1 BLOCK |
| `TC-EVID-W01-013` | `TC-W01` | `TC-ISSUE-001` | r004 review remediation 6 | rooted DOS device、legacy drive、control character 与 unknown Action fail-closed | [S11 r004 review remediation 6](team-runtime/tc-w01/s11-r004-review-remediation-6.md) | `superseded` | full deterministic passed；exact review `TC-EVID-W01-014` failed |
| `TC-EVID-W01-014` | `TC-W01` | `TC-ISSUE-001` | r004 independent review 6 | exact `74dde015...` decoded control、device whitespace、relative path 和 docs version P1 | [S11 r004 independent review 6](team-runtime/tc-w01/s11-r004-independent-review-6.md) | `failed` | code P1=2；security P1=1；docs P1=1 |
| `TC-EVID-W01-015` | `TC-W01` | `TC-ISSUE-001` | r004 review remediation 7 | decoded control、device base、cross-platform relative path 与 r004 docs | [S11 r004 review remediation 7](team-runtime/tc-w01/s11-r004-review-remediation-7.md) | `superseded` | full deterministic passed；exact review `TC-EVID-W01-016` failed |
| `TC-EVID-W01-016` | `TC-W01` | `TC-ISSUE-001` | r004 independent review 7 | exact `a7dd4b27...` host absolute、ADS、Win32 alias 与 invalid UTF-8 P1 | [S11 r004 independent review 7](team-runtime/tc-w01/s11-r004-independent-review-7.md) | `failed` | code P1=2；security P1=2；docs PASS |
| `TC-EVID-W01-017` | `TC-W01` | `TC-ISSUE-001` | r004 review remediation 8 | portable absolute、ADS、Win32 alias、decoded control 与 UTF-8 boundary | [S11 r004 review remediation 8](team-runtime/tc-w01/s11-r004-review-remediation-8.md) | `superseded` | full deterministic passed；exact review `TC-EVID-W01-018` failed |
| `TC-EVID-W01-018` | `TC-W01` | `TC-ISSUE-001` | r004 independent review 8 | exact `e07276ef...` leading/trailing whitespace P1 | [S11 r004 independent review 8](team-runtime/tc-w01/s11-r004-independent-review-8.md) | `failed` | code P1=1；security/docs PASS |
| `TC-EVID-W01-019` | `TC-W01` | `TC-ISSUE-001` | r004 review remediation 9 | Registry/relative path leading/trailing whitespace fail-closed | [S11 r004 review remediation 9](team-runtime/tc-w01/s11-r004-review-remediation-9.md) | `passed` | full deterministic passed；final exact review in `TC-EVID-W01-020` |
| `TC-EVID-W01-020` | `TC-W01` | `TC-ISSUE-001` | r004 final exact review | exact `a25628ae...` deterministic Gate 与三路 P0/P1=0 | [S12 r004 final verification](team-runtime/tc-w01/s12-r004-final-verification.md) | `passed` | code/security/docs PASS |
