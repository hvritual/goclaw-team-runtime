...
| `TC-EVID-W01-019` | `TC-W01` | `TC-ISSUE-001` | r004 review remediation 9 | Registry/relative path leading/trailing whitespace fail-closed | [S11 r004 review remediation 9](team-runtime/tc-w01/s11-r004-review-remediation-9.md) | `collecting` | full deterministic passed；exact review pending |
