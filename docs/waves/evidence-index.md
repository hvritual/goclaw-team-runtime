...
| `TC-EVID-W01-015` | `TC-W01` | `TC-ISSUE-001` | r004 review remediation 7 | decoded control、device base、cross-platform relative path 与 r004 docs | [S11 r004 review remediation 7](team-runtime/tc-w01/s11-r004-review-remediation-7.md) | `collecting` | full deterministic Gate passed；exact review pending |
