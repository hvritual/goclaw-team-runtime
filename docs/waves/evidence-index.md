...
| `TC-EVID-W01-003` | `TC-W01` | `TC-ISSUE-001` | r003 remediation | 复合 key、Context identity、secret-safe schema、CRUD、UI 五状态与 replay no-op | [S07 r003 remediation verification](team-runtime/tc-w01/s07-r003-remediation-verification.md) | `collecting` | deterministic gates passed；exact-commit independent review pending |
