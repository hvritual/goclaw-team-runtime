...
| `TC-EVID-W01-013` | `TC-W01` | `TC-ISSUE-001` | r004 review remediation 6 | rooted DOS device、legacy drive、control character 与 unknown Action fail-closed | [S11 r004 review remediation 6](team-runtime/tc-w01/s11-r004-review-remediation-6.md) | `collecting` | full deterministic Gate passed；exact review pending |
