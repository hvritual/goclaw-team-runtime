...
| `TC-EVID-W01-011` | `TC-W01` | `TC-ISSUE-001` | r004 remediation | lexical path、superscript DOS device、error/length boundary 与 RBAC provenance 前向实现 | [S10 r004 remediation verification](team-runtime/tc-w01/s10-r004-remediation-verification.md) | `collecting` | deterministic passed；new exact-commit review pending |
