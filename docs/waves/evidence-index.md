...
| `TC-EVID-W01-005` | `TC-W01` | `TC-ISSUE-001` | r003 review remediation 2 | 初审全部 P1、主要 P2 与完整 Evidence/JSON 合同前向修复 | [S08 r003 review remediation 2](team-runtime/tc-w01/s08-r003-review-remediation-2.md) | `collecting` | deterministic passed；new exact-commit review pending |
...
| `TC-EVID-W01-007` | `TC-W01` | `TC-ISSUE-001` | r003 review remediation 3 | parsed/unescaped file URI UNC/device 与父目录写边界 | [S08 r003 review remediation 3](team-runtime/tc-w01/s08-r003-review-remediation-3.md) | `collecting` | deterministic passed；new exact-commit review pending |
...
| `TC-EVID-W01-009` | `TC-W01` | `TC-ISSUE-001` | r003 review remediation 4 | DOS/NT device、Unix pseudo-filesystem、错误脱敏与 Policy canonical trim | [S08 r003 review remediation 4](team-runtime/tc-w01/s08-r003-review-remediation-4.md) | `collecting` | deterministic passed；new exact-commit review pending |
