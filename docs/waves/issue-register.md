...
| `TC-ISSUE-001` | 中央全局治理 | 现有 TeamControl 文件存储与 RPC | 管理预算、知识源、Skill、Runner release 和 Context Bundle | r002 实现补齐基础能力，但 exact review 复现跨项目裸 ID、Context target identity、secret schema、CRUD/UI Evidence 与 traceability P1 | `S1` | `fixing` | [`TC-EVID-W01-002`](team-runtime/tc-w01/s05-independent-review-r002.md) failed；[`TC-EVID-W01-004`](team-runtime/tc-w01/s08-r003-independent-review-1.md) failed；[`TC-EVID-W01-006`](team-runtime/tc-w01/s08-r003-independent-review-2.md) failed；[`TC-EVID-W01-008`](team-runtime/tc-w01/s08-r003-independent-review-3.md) failed；[`TC-EVID-W01-009`](team-runtime/tc-w01/s08-r003-review-remediation-4.md) collecting；[`r003 Freeze`](team-runtime/tc-w01/task-freeze-r003.md) | `TC-W01-S07`–`S08` | `TC-W01-ACCEPTANCE-004` r003 |
