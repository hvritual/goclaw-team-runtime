...
| `RN-ISSUE-001` | Runner 生命周期 | r004 exact `d6a166...` 独立验收 | 兼容性协商、双 execution profile、受限设备身份、当前策略 claim、校验更新、原子升级与回滚 | code/security/docs 确认成员 Token、policy/claim、release executable/lock、Windows owner/cross-test、legacy migration 与文档 P1；r005 前向修复 | `S1` | `fixing` | [`RN-W01 r005`](team-runtime/rn-w01/plan-r005.md)；remote activation `40e796...`；[r005 Task Freeze](team-runtime/rn-w01/task-freeze-r005.md) | `RN-W01-S07A`–`S08` | `RN-W01-LIFECYCLE-001` r005 |
