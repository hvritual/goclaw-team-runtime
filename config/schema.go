...
type Config struct {
	...
	Governance  governance.Config       `mapstructure:"governance" json:"governance"`
	Harness     harness.Config          `mapstructure:"harness" json:"harness"`
	Ouroboros   ouroboros.Config        `mapstructure:"ouroboros" json:"ouroboros"`
	Development orchestratorlite.Config `mapstructure:"development" json:"development"`
	TeamControl teamcontrol.Config      `mapstructure:"team_control" json:"team_control"`
	Workstation workstation.Config      `mapstructure:"workstation" json:"workstation"`
...
type MemoryConfig struct {
	...
	Catalog catalog.Config      `mapstructure:"catalog" json:"catalog"`
}
