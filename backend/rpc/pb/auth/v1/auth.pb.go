...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\aauth.v1\x1a\x1bannotations/v1/access.proto\x1a\x1cgoogle/api/annotations.proto\"\r\n" +
	"\vPingRequest\"(\n" +
	"\fPingResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2u\n" +
	"\vAuthService\x12P\n" +
	"\x04Ping\x12\x14.auth.v1.PingRequest\x1a\x15.auth.v1.PingResponse\"\x1b\xd2\xf3\x18\x028\x01\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/auth/ping\x1a\x14\xca\xf3\x18\x10\n" +
