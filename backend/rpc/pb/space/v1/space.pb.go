...
const file_space_v1_space_proto_rawDesc = "" +
	"\n" +
	"\x14space/v1/space.proto\x12\bspace.v1\x1a\x1bannotations/v1/access.proto\x1a\x1cgoogle/api/annotations.proto\"\r\n" +
	"\vPingRequest\"(\n" +
	"\fPingResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2{\n" +
	"\fSpaceService\x12S\n" +
	"\x04Ping\x12\x15.space.v1.PingRequest\x1a\x16.space.v1.PingResponse\"\x1c\xd2\xf3\x18\x028\x01\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/space/ping\x1a\x16\xca\xf3\x18\x12\n" +
...
var (
	...
	file_space_v1_space_proto_rawDescData []byte
)

func file_space_v1_space_proto_rawDescGZIP() []byte {
	file_space_v1_space_proto_rawDescOnce.Do(func() {
		file_space_v1_space_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_space_v1_space_proto_rawDesc), len(file_space_v1_space_proto_rawDesc)))
	})
	return file_space_v1_space_proto_rawDescData
}

var file_space_v1_space_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_space_v1_space_proto_goTypes = []any{
	(*PingRequest)(nil),  // 0: space.v1.PingRequest
	(*PingResponse)(nil), // 1: space.v1.PingResponse
}
var file_space_v1_space_proto_depIdxs = []int32{
	0, // 0: space.v1.SpaceService.Ping:input_type -> space.v1.PingRequest
	1, // 1: space.v1.SpaceService.Ping:output_type -> space.v1.PingResponse
