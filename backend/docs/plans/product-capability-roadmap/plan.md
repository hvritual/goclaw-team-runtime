...
The approved execution snapshot is [plan_v2.md](plan_v2.md).

- Plan-ID: `PRODUCT-CAPABILITY-ROADMAP-001`
- Approved version: `2`
- Active step: `PCR-S01B-1 — Contract and migration`
- Status: `approved-for-execution; PCR-S01B-1 active`
- Plan base commit: `45213820fade7f61294d2287e063bf19fbd015ee`
- Active task base commit: `312feda1aeaafb5d1aecffd61a7fbcdcbd7ee3c6`
...
The Human Customer explicitly approved `PRODUCT-CAPABILITY-ROADMAP-001 v2` on
2026-08-16. That approval activates only `PCR-S01B-1` through the frozen task in
the register. Later steps still require the current step to close, a new frozen
task, base and policy revalidation, and an updated active-step pointer.
