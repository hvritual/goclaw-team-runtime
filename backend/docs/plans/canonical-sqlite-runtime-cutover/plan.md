...
- Approved version: `7`
- Active step: `M1-S7-C7-ACCEPT`
- Status: `approved; C7 deterministic and clean-candidate browser evidence accepted technically; Human Customer acceptance pending`
